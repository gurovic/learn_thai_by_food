...
const russianOverrides = {
  ...
  "กวยจั๊บ": "рулоны рисовой лапши в перечном бульоне с субпродуктами",
  "ฉู่ฉี่ปลาทูสด": "свежая скумбрия в густом красном карри",
  "ต้มยำโบราณ": "лапша в густом кисло-остром соусе или бульоне",
  "ต้มเยื่อไผ่": "прозрачный суп с бамбуковым грибом",
  "ลาบเนื้อดิบ": "северный острый салат из рубленой сырой говядины",
  "ตำมะเขือ": "толченый салат из длинных зеленых баклажанов на гриле",
  "ไข่พะโล้": "яйца и мясо в соевом бульоне с китайскими пряностями",
  "แกงโฮะ": "северное жареное карри со стеклянной лапшой",
  "แกงแค": "северное карри из трав, овощей и мяса",
  "แกงเหลือง": "южное кислое желтое карри без кокосового молока",
  "แกงผักเซียงดา": "северное карри с листьями гимнемы и сушеной рыбой",
  "แกงไตปลา": "острое южное карри с овощами и соусом из рыбных внутренностей",
  "กุ้งแช่น้ำปลา": "сырые креветки в рыбном соусе с острой лаймовой заправкой",
  "ตำมะพร้าวอ่อนเส้นหมี่กรอบ": "салат из молодого кокоса с хрустящей рисовой лапшой",
  "ยำหัวปลีทอด": "острый салат с жареными цветками банана",
  "หมูผัดสะตอภาคใต้": "южная свинина, обжаренная с бобами сато и чили",
  "หน่อยัดไส้ทอด": "жареные побеги бамбука с мясной начинкой",
  "ปลาบ้วง": "соленая вяленая змееголовая рыба",
  "ปลานิลทอดสมุนไพร": "жареная тилапия с хрустящими травами",
  "ปลาทอดขมิ้น": "южная жареная рыба с куркумой",
  "เมี่ยงปลา": "рыба с травами и овощами для заворачивания в листья",
  "ข้าวต้มมัด": "клейкий рис с бананом на пару в банановом листе",
...
function conciseRussian(text = "") {
  ...
  if ((result.match(/\(/g) || []).length > (result.match(/\)/g) || []).length) {
    result = result.slice(0, result.lastIndexOf("(")).trim().replace(/[,;:]+$/, "");
  }
  if (/\b(и|или|с|со|из|для|под|на|в|во|к|по|от|до|без|при|из-за|в течение)$/iu.test(result)) {
    const comma = result.lastIndexOf(",");
    result = comma >= 30 ? result.slice(0, comma) : result.replace(/\s+\S+(?:\s+\S+)?$/, "");
  }
